...
@implementation ARCloudSession

@synthesize viewport;

- (id)initWithDelegate:(id<ARCloudControl>) delegate
{
    self = [super init];
    if (self) {
...
- (void)initVuforiaInBackground
{
    ...
    @autoreleasepool {
        Vuforia::setInitParameters(mVuforiaInitFlags,"");
