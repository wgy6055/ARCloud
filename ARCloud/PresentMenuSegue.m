...
- (void)perform {
    ...
    ARCloudMenuViewController *menuViewController = (ARCloudMenuViewController*)self.destinationViewController;
    
    CGRect ARViewStartFrame = ARViewController.view.frame;
    CGFloat menuWidthScale = [ARCloudMenuViewController getMenuWidthScale];
